    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 p-4 transition-colors duration-300">
      <Card className="w-full max-w-md bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 transition-colors duration-300">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold text-gray-900 dark:text-gray-100 transition-colors">Welcome Back</CardTitle>
          <p className="text-gray-600 dark:text-gray-400 transition-colors">Sign in to your LAW-AI account</p>
        </CardHeader>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 dark:bg-[#1E1E1E] dark:border-[#333] dark:text-white dark:placeholder-[#aaa]"
                  required
                />
                <button
                  type="button"
