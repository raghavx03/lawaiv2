...
export function generateDocument(type: string, inputs: Record<string, string>): string {
  ...
  for (const [key, value] of Object.entries(inputs)) {
    ...
    document = document.replace(new RegExp(placeholder.replace(/[{}]/g, '\\$&'), 'g'), value || '_____________')
  }
