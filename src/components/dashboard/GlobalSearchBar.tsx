  ...
  return (
    <div ref={searchRef} className="relative w-full max-w-2xl mx-auto">
      ...
      >
        ...
        <div className="relative bg-white/98 dark:bg-[#1E1E1E]/98 backdrop-blur-2xl rounded-3xl p-4 shadow-2xl border border-gray-200/50 dark:border-[#333]/50 transition-all duration-500 hover:shadow-3xl hover:border-blue-300/50 dark:hover:border-blue-600/50 focus-within:border-blue-400/70 dark:focus-within:border-blue-500/70 focus-within:shadow-blue-200/20 dark:focus-within:shadow-blue-900/20 focus-within:shadow-2xl group">
          <div className="flex items-center gap-4">
            ...
            <input
              ...
              className="flex-1 border-none outline-none text-lg bg-transparent text-gray-900 dark:text-white font-medium placeholder-gray-500 dark:placeholder-[#aaa] transition-colors duration-300 focus:placeholder-gray-400 dark:focus:placeholder-[#888]"
              style={{
            ...
            {query && (
              <button
                onClick={clearSearch}
                className="text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 transition-all duration-300 p-1 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800"
              >
                <X className="h-5 w-5" />
              </button>
            )}
      ...
      {/* Search Results Dropdown - Landing page style */}
      <AnimatePresence>
        {isOpen && results.length > 0 && (
          ...
          >
            <div className="bg-white/99 dark:bg-gray-900/99 backdrop-blur-2xl rounded-2xl shadow-2xl border border-gray-200/60 dark:border-gray-700/60 max-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
              {results.map((result, index) => (
                <motion.div
                  ...
                  className={`
                    ...
                    border-b border-gray-100/60 dark:border-gray-700/60 last:border-b-0
                    ${
                      selectedIndex === index 
      ...
      <AnimatePresence>
        {isOpen && query.length > 0 && results.length === 0 && (
          <motion.div
            ...
            className="absolute top-full left-0 right-0 mt-2 z-50"
          >
            <div className="bg-white/99 dark:bg-gray-900/99 backdrop-blur-2xl rounded-2xl shadow-2xl border border-gray-200/60 dark:border-gray-700/60 p-8 text-center">
