            ...
            <div className="flex items-center gap-2">
              ...
              {!trialStatus.isPaidUser && trialStatus.daysLeft > 0 && (
                <button
                  ...
                  className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 bg-amber-50 text-amber-700 rounded-full text-xs font-medium hover:bg-amber-100 transition-colors"
                >
              ...
              {/* Home button */}
              <Link href="/">
                <button className="p-2 rounded-xl text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-colors">
